...
sourcesIndex["gpu_display"] = {"name":"","files":["dwl.rs","event_device.rs","gpu_display_stub.rs","gpu_display_wl.rs","lib.rs"]};
...
sourcesIndex["rutabaga_gfx"] = {"name":"","dirs":[{"name":"cross_domain","files":["cross_domain.rs","cross_domain_protocol.rs","mod.rs"]},{"name":"generated","files":["mod.rs","virgl_renderer_bindings.rs"]},{"name":"rutabaga_gralloc","files":["formats.rs","gralloc.rs","mod.rs","system_gralloc.rs"]}],"files":["lib.rs","macros.rs","rutabaga_2d.rs","rutabaga_core.rs","rutabaga_utils.rs"]};
...
sourcesIndex["sys_util"] = {"name":"","dirs":[{"name":"linux","files":["mod.rs","syslog.rs"]}],"files":["alloc.rs","capabilities.rs","clock.rs","descriptor.rs","descriptor_reflection.rs","errno.rs","eventfd.rs","external_mapping.rs","file_flags.rs","file_traits.rs","fork.rs","get_filesystem_type.rs","handle_eintr.rs","ioctl.rs","lib.rs","mmap.rs","net.rs","poll.rs","priority.rs","rand.rs","raw_fd.rs","read_dir.rs","sched.rs","scoped_path.rs","scoped_signal_handler.rs","seek_hole.rs","shm.rs","signal.rs","signalfd.rs","sock_ctrl_msg.rs","syslog.rs","terminal.rs","timerfd.rs","vsock.rs","write_zeroes.rs"]};
...
sourcesIndex["vm_control"] = {"name":"","files":["client.rs","lib.rs"]};
